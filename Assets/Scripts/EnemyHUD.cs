...
public class EnemyHUD : MonoBehaviour //Canvas에 추가되어있음
{
    ...
    [SerializeField] private GameObject hpPrefeb = null; //hp바 프리팹
    [SerializeField] private GameObject levelPrefeb = null;//몬스터 레벨 프리팹
    [SerializeField] private GameObject arrowPrefeb = null; //화살표 프리팹
    private Dictionary<Transform, GameObject> hpBarDict = new Dictionary<Transform, GameObject>();
    private Dictionary<Transform, GameObject> levelDict = new Dictionary<Transform, GameObject>();
    ...
    public void DisappearEnemyInfo()//기존 타겟 정보 안 보이게
    {
        arrow.SetActive(false);
